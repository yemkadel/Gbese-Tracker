...
class DetailsView: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        _ = GbeseModel.curveAllEdges(object: panview)
        ...
        _ = GbeseModel.curveTwoEdges(object: containerView, edges: [.layerMinXMaxYCorner,.layerMaxXMaxYCorner], cornerRadius: 10)
    ...
    func goToList(){
        ...
        let gbeseListVC = storyboard1.instantiateViewController(identifier: "GbeseListViewController") as! GbeseListViewController
